...
config :toggl_bexio_sync, TogglBexioSyncWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "ChMqL/PR+EmvBtbSFXU/Njshn58OoRkdhqJSNMV8iuEORs4ddXAuetHq4v7CJuNM",
  watchers: [
...
config :toggl_bexio_sync, TogglBexioSyncWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/toggl_bexio_sync_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :toggl_bexio_sync, dev_routes: true
