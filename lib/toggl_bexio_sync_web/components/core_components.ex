defmodule TogglBexioSyncWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TogglBexioSyncWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TogglBexioSyncWeb.Gettext, "errors", msg, opts)
    end
  end
